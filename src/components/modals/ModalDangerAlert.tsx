...
const ModalDangerAlert = ({ text, onOk }: Props) => {
    ...
    <div className="fixed inset-0 flex justify-center items-center z-40">
      ...
      >
        <div className="w-full flex flex-col justify-center items-center gap-5">
          <div className="size-[100px] rounded-full bg-[#D32F2F]/20 flex items-center justify-center">
            <div className="size-20 rounded-full bg-[#D32F2F]/20 flex items-center justify-center shadow">
              <ExclamationIcon color="#D32F2F" size={40} />
            </div>
          </div>

          <div className="w-full flex flex-col justify-center items-center">
            <p className="font-semibold text-3xl text-[#D32F2F]">
              {t("modalDangerAlert.title")}
            </p>
        ...
        <div className="w-full flex justify-between gap-2">
          <button className="w-full bred" onClick={onOk}>
            {t("buttons.btn_ok")}
          </button>
        </div>
      </div>
...
export default ModalDangerAlert;
